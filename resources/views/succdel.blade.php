    ...
    <div class="text-white mt-40">
        ...
        <div class="flex justify-center">
            <div class="bg-gray-950 w-[50%] p-3 flex flex-col">
                <p class="text-center mb-12 mt-6">Succesfully Deleted Album</p>
                ...
                <a href="{{ route('') }}" class="  text-center cursor-pointer p-1 bg-blue-600 hover:bg-blue-700 duration-200 active:bg-blue-800">Delete Another Album</a>
            </div>
        </div>
    <div>
</body>
